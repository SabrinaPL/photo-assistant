...
export class PhotoAssistantOrchestrator {
  ...
  /**
   * @deprecated - this function has been renamed, use clearAllPhotosFromStorage instead.
   */
  clearPhotosFromStorage () {
    console.warn('clearPhotosFromStorage has been renamed and is now deprecated and will be removed in a future version. Instead use clearAllPhotosFromStorage.')
  }

  /**
   * @deprecated - an instance of photo filter is automatically instantiated in the photoAssistantOrchestrator constructor in v.2 of PhotoAssistant, this function does not need to be called anymore and will be removed in a future release.
   */
  startPhotoFilter () {
    console.warn('startPhotoFilter is deprecated and will be removed in a future version.')
  }

  /** 
   * @deprecated - this function has been renamed, use saveImage instead.
   * 
   */
  addImage () {
    console.warn('addImage has been renamed and is now deprecated and will be removed in a future version. Instead use saveImage.')
  }
}
