...
export class PhotoGallery {
  ...
  #createGridGallery (columns, galleryElement) {
    ...
    this.#galleryElement.style.gridTemplateColumns = this.#gridColumns
    this.#galleryElement.style.gridTemplateRows = this.#gridRows

    for (let i = 0; i < numberOfPhotos.length + 1; i++) {
